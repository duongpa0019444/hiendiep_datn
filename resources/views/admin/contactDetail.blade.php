    ...
    <div class="container-xxl">
        <nav aria-label="breadcrumb p-0">
            <ol class="breadcrumb py-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.contact') }}">Quản lí Hỗ Trợ Tin Nhắn</a></li>
                <li class="breadcrumb-item active">Chi tiết thông tin hỗ trợ</li>
            </ol>
        </nav>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="approveForm" action="{{ route('admin.contact.approve', ['id' => $contact->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ optional($contact->staff)->name ?? 'Chưa có' }}" readonly>
                            </div>
                        </div>
                    ...
                    <div class="p-3 bg-light mb-3 rounded mt-4">
                        <div class="row justify-content-end g-2">
                            <div class="col-lg-2">
                                <a href="{{ route('admin.contact.reject', ['id' => $contact->id]) }}"
                                   id="btn-reject"
