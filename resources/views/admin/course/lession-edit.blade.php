                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control"value="{{ $lession->name }}" >
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="link_document" id="link_document" class="form-control" value="{{ $lession->link_document }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="updated_at" class="form-label">Ngày cập nhật bài giảng </label>
                                        <input type="datetime-local" name="updated_at" id="updated_at" class="form-control" value="{{ $lession->updated_at }}">
                                    </div>
                                </div>
