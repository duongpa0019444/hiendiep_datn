    ...
    <div class="page-content">
        <div class="container-fluid ">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="avatar-md bg-primary bg-opacity-10 rounded">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55"
                                        ...
                                        <radialGradient id="notoManStudentLightSkinTone0" cx="64.001" cy="81.221"
                                            r="37.873" gradientTransform="matrix(1 0 0 -1.1282 0 138.298)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset=".794" stop-color="#454140" stop-opacity="0" />
                                            <stop offset="1" stop-color="#454140" />
                                        </radialGradient>
                                        <path fill="url(#notoManStudentLightSkinTone0)"
                                        ...
                                        <ellipse cx="114.25" cy="53.05" fill="#ffca28" rx="2.76"
                                            ry="2.63" />
                                        <path fill="#504f4f"
                                            d="M114.25 53.02c-.55 0-1-.45-1-1v-38c0-.55.45-1 1-1s1 .45 1 1v38c0 .56-.45 1-1 1" />
                                        <linearGradient id="notoManStudentLightSkinTone1" x1="64" x2="64"
                                            y1="127.351" y2="98.71" gradientTransform="matrix(1 0 0 -1 0 128)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset=".003" stop-color="#424242" />
                                            <stop offset=".472" stop-color="#353535" />
                                            <stop offset="1" stop-color="#212121" />
                                        </linearGradient>
                                        <path fill="url(#notoManStudentLightSkinTone1)"
                                        ...
                                        <linearGradient id="notoManStudentLightSkinTone2" x1="64" x2="64"
                                            y1="127.184" y2="96.184" gradientTransform="matrix(1 0 0 -1 0 128)"
                                            gradientUnits="userSpaceOnUse">
                                        ...
                                        <path fill="url(#notoManStudentLightSkinTone2)"
                                            d="M64 4.98s-21.17.25-52 8c0 0 35.41 9.67 52 9.38c16.59.29 52-9.38 52-9.38c-30.83-7.75-52-8-52-8" />
                                        <linearGradient id="notoManStudentLightSkinTone3" x1="13.893" x2="114.721"
                                            y1="109.017" y2="109.017" gradientTransform="matrix(1 0 0 -1 0 128)"
                                            gradientUnits="userSpaceOnUse">
                                        ...
                                        <radialGradient id="notoManStudentLightSkinTone4" cx="64" cy="5.397"
                                            r="54.167" gradientTransform="matrix(1 0 0 -.5247 0 125.435)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset=".598" stop-color="#212121" />
                                            <stop offset="1" stop-color="#616161" />
                                        </radialGradient>
                                        <path fill="url(#notoManStudentLightSkinTone4)"
                                            d="M114.5 120.99c0-14.61-21.75-21.54-40.72-23.1l-8.6 11.03c-.28.36-.72.58-1.18.58s-.9-.21-1.18-.58L54.2 97.87c-10.55.81-40.71 4.75-40.71 23.12V124h101z" />
                                    </svg>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="avatar-md bg-primary bg-opacity-10 rounded">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55"
                                        viewBox="0 0 128 128">
                                        <linearGradient id="notoTeacherLightSkinTone0" x1="63.999" x2="63.999"
                                            y1="116.605" y2="39.511" gradientTransform="matrix(1 0 0 -1 0 128)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset="0" stop-color="#26a69a" />
                                            <stop offset="1" stop-color="#00796b" />
                                        </linearGradient>
                                        <path fill="url(#notoTeacherLightSkinTone0)" d="M6.36 10.9h115.29v77.52H6.36z" />
                                        <linearGradient id="notoTeacherLightSkinTone1" x1="63.999" x2="63.999"
                                            y1="119.455" y2="37.224" gradientTransform="matrix(1 0 0 -1 0 128)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset="0" stop-color="#8d6e63" />
                                            <stop offset=".779" stop-color="#795548" />
                                        </linearGradient>
                                        <path fill="url(#notoTeacherLightSkinTone1)"
                                            d="M119.29 13.26v72.81H8.71V13.26zM124 8.55H4v82.23h120z" />
                                        <path fill="#312d2d"
                                        ...
                                        <radialGradient id="notoTeacherLightSkinTone2" cx="99.638" cy="45.85"
                                            r="23.419" gradientTransform="matrix(1 0 0 .4912 -21.055 59.629)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset=".728" stop-color="#454140" stop-opacity="0" />
                                            <stop offset="1" stop-color="#454140" />
                                        </radialGradient>
                                        <path fill="url(#notoTeacherLightSkinTone2)"
                                            d="M63.99 95.79v-9.44l28.57-2.26l2.6 3.2s-6.15 8.51-22.23 8.51z" />
                                        <radialGradient id="notoTeacherLightSkinTone3" cx="76.573" cy="49.332"
                                            r="6.921" gradientTransform="matrix(-.9057 .4238 -.3144 -.6719 186.513 79.36)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset=".663" stop-color="#454140" />
                                            <stop offset="1" stop-color="#454140" stop-opacity="0" />
                                        </radialGradient>
                                        <path fill="url(#notoTeacherLightSkinTone3)"
                                        ...
                                        <radialGradient id="notoTeacherLightSkinTone4" cx="94.509" cy="68.91"
                                            r="30.399"
                                        ...
                                        <path fill="url(#notoTeacherLightSkinTone4)"
                                        ...
                                        <radialGradient id="notoTeacherLightSkinTone5" cx="44.31" cy="68.91"
                                            r="30.399"
                                        ...
                                        <path fill="url(#notoTeacherLightSkinTone5)"
                                        ...
                                        <radialGradient id="notoTeacherLightSkinTone6" cx="49.439" cy="45.85"
                                            r="23.419" gradientTransform="matrix(-1 0 0 .4912 98.878 59.629)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset=".728" stop-color="#454140" stop-opacity="0" />
                                            <stop offset="1" stop-color="#454140" />
                                        </radialGradient>
                                        <path fill="url(#notoTeacherLightSkinTone6)"
                                            d="M64.03 95.79v-9.44l-28.57-2.26l-2.6 3.2s6.15 8.51 22.23 8.51z" />
                                        <radialGradient id="notoTeacherLightSkinTone7" cx="26.374" cy="49.332"
                                            r="6.921" gradientTransform="matrix(.9057 .4238 .3144 -.6719 -13.024 100.635)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset=".663" stop-color="#454140" />
                                            <stop offset="1" stop-color="#454140" stop-opacity="0" />
                                        </radialGradient>
                                        <path fill="url(#notoTeacherLightSkinTone7)"
                                        ...
                                        <linearGradient id="notoTeacherLightSkinTone8" x1="64" x2="64"
                                            y1="25.908" y2="10.938" gradientTransform="matrix(1 0 0 -1 0 128)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset="0" stop-color="#e1f5fe" />
                                            <stop offset="1" stop-color="#81d4fa" />
                                        </linearGradient>
                                        <path fill="url(#notoTeacherLightSkinTone8)"
                                            d="M114.5 120.75c0-15.47-25.34-23.56-50.36-23.56H64c-25.14.03-50.5 7.32-50.5 23.56V124h101z" />
                                        <path fill="#edc391" d="M64 92.33h-9.08v9.98l9.06 2.38l9.1-2.38v-9.98z" />
                                        <linearGradient id="notoTeacherLightSkinTone9" x1="29.113" x2="29.113"
                                            y1="29.156" y2="4.97" gradientTransform="matrix(1 0 0 -1 0 128)"
                                            gradientUnits="userSpaceOnUse">
                                        ...
                                        <path fill="url(#notoTeacherLightSkinTone9)"
                                            d="M12 120.75V124h32.89l1.33-27.04C27.52 99.72 12 107.15 12 120.75" />
                                        <linearGradient id="notoTeacherLightSkinTonea" x1="98.888" x2="98.888"
                                            y1="29.435" y2="4.807" gradientTransform="matrix(1 0 0 -1 0 128)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset="0" stop-color="#ffa000" />
                                            <stop offset=".341" stop-color="#ff9300" />
                                            <stop offset=".972" stop-color="#ff7100" />
                                        ...
                                        <path fill="url(#notoTeacherLightSkinTonea)"
                                            d="M81.78 96.96L83.1 124H116v-3.25c0-13.6-15.52-21.03-34.22-23.79" />
                                        ...
                                        <path fill="#af5214"
                                            d="M48.88 95s-1.14 2.72-1.94 6c-1.59 6.52-1.69 15.8-1.69 15.8s-6.89-2.34-9.04-8.05c-2.54-6.75 1.75-10.46 1.75-10.46s.9-.38 4.68-2.46s6.24-.83 6.24-.83m30.24 0s1.14 2.72 1.94 6c1.59 6.52 1.69 15.8 1.69 15.8s6.89-2.34 9.04-8.05c2.54-6.75-1.75-10.46-1.75-10.46s-.9-.38-4.68-2.46s-6.24-.83-6.24-.83" />
                                        <path fill="#edc391"
                                            d="M91.12 50.43H36.47c-5.89 0-10.71 5.14-10.71 11.41s4.82 11.41 10.71 11.41h54.65c5.89 0 10.71-5.14 10.71-11.41s-4.82-11.41-10.71-11.41" />
                                        <path fill="#f9ddbd"
                                            d="M63.79 11.07c-17.4 0-33.52 18.61-33.52 45.4c0 26.64 16.61 39.81 33.52 39.81S97.31 83.1 97.31 56.46c0-26.78-16.11-45.39-33.52-45.39" />
                                        <g fill="#312d2d">
                                        ...
                                        <path fill="#dba689"
                                            d="M67.65 68.06c-.11-.04-.21-.07-.32-.08h-7.08c-.11.01-.22.04-.32.08c-.64.26-.99.92-.69 1.63s1.71 2.69 4.55 2.69s4.25-1.99 4.55-2.69c.31-.71-.05-1.37-.69-1.63" />
                                        <path fill="#444"
                                            d="M72.32 76.14c-3.18 1.89-13.63 1.89-16.81 0c-1.83-1.09-3.7.58-2.94 2.24c.75 1.63 6.44 5.42 11.37 5.42s10.55-3.79 11.3-5.42c.76-1.66-1.09-3.33-2.92-2.24" />
                                        <path fill="#212121" stroke="#212121" stroke-miterlimit="10" stroke-width="0.55"
                                        ...
                                        <linearGradient id="notoTeacherLightSkinToneb" x1="79.569" x2="76.946"
                                            y1="22.713" y2="11.668" gradientTransform="matrix(1 0 0 -1 0 128)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset=".002" stop-color="#212121" stop-opacity="0.2" />
                                            <stop offset="1" stop-color="#212121" stop-opacity="0.6" />
                                        </linearGradient>
                                        <path fill="url(#notoTeacherLightSkinToneb)"
                                            d="m101.67 121.61l.57-2.2l.01-.05l1.93-7.6l-6.9-1.98l-34.92-10.03c-.05-.01-.09-.01-.13-.03a6.177 6.177 0 0 0-7.51 4.27L48.97 124h52.02z"
                                            opacity="0.67" />
                                        <path fill="#424242"
                                            d="M105.75 111.88c.29-1.01-.29-2.06-1.3-2.34l-38.69-11.1a6.19 6.19 0 0 0-7.65 4.24L52 124h50.28z" />
                                        <linearGradient id="notoTeacherLightSkinTonec" x1="81.84" x2="79.869"
                                            y1="17.098" y2="10.486" gradientTransform="matrix(1 0 0 -1 0 128)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset="0" stop-color="#ef5350" />
                                            <stop offset="1" stop-color="#e53935" />
                                        </linearGradient>
                                        <path fill="url(#notoTeacherLightSkinTonec)"
                                            d="M105.08 120.31c.35-1.22-.38-2.5-1.62-2.85l-41.52-11.9c-4.53-1.3-5.32 2.35-6.59 6.78L52 124h52.02z" />
                                        <linearGradient id="notoTeacherLightSkinToned" x1="58.405" x2="60.268"
                                            y1="19.113" y2="24.969" gradientTransform="matrix(1 0 0 -1 0 128)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset="0" stop-color="#212121" />
                                            <stop offset="1" stop-color="#424242" />
                                        </linearGradient>
                                        <path fill="url(#notoTeacherLightSkinToned)"
                                            d="M63.26 98.24a6.17 6.17 0 0 0-5.14 4.42L52 124h3.87z" />
                                        <path fill="#424242"
                                            d="M64.33 101.57c.18 0 .38.02.59.07l37.25 10.7l-.31 1.08c-11.79-3.29-34.29-9.62-38.94-11.16c.24-.33.71-.69 1.41-.69m0-3.33c-4.52 0-6.78 5.57-3.12 6.94c4.03 1.5 42.93 12.32 42.93 12.32l1.58-5.52c.31-1.06-.19-2.14-1.11-2.4L65.77 98.42q-.75-.18-1.44-.18"
                                            opacity="0.2" />
                                        <linearGradient id="notoTeacherLightSkinTonee" x1="-117.44" x2="-73.995"
                                            y1="-972.312" y2="-972.312"
                                        ...
                                        <path fill="url(#notoTeacherLightSkinTonee)"
                                            d="m103.37 112.12l-39.8-11.42c-1.08-.31-2.26.46-2.62 1.71l-.06.22c-.36 1.25.23 2.53 1.31 2.84l39.8 11.42s-.34-.83.07-2.3c.41-1.48 1.3-2.47 1.3-2.47" />
                                        <path fill="#312d2d"
                                        ...
                                        <radialGradient id="notoTeacherLightSkinTonef" cx="82.019" cy="84.946"
                                            r="35.633" gradientTransform="matrix(.3076 .9515 .706 -.2282 -3.184 -15.605)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset=".699" stop-color="#454140" stop-opacity="0" />
                                            <stop offset="1" stop-color="#454140" />
                                        </radialGradient>
                                        <path fill="url(#notoTeacherLightSkinTonef)"
                                        ...
                                        <radialGradient id="notoTeacherLightSkinToneg" cx="47.28" cy="123.8"
                                            r="9.343" gradientTransform="matrix(.8813 .4726 .5603 -1.045 -63.752 111.228)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset=".58" stop-color="#454140" />
                                            <stop offset="1" stop-color="#454140" stop-opacity="0" />
                                        </radialGradient>
                                        <path fill="url(#notoTeacherLightSkinToneg)"
                                        ...
                                        <radialGradient id="notoTeacherLightSkinToneh" cx="159.055" cy="62.862"
                                            r="28.721" gradientTransform="matrix(-.9378 -.3944 -.2182 .5285 231.04 50.678)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset=".699" stop-color="#454140" stop-opacity="0" />
                                            <stop offset="1" stop-color="#454140" />
                                        </radialGradient>
                                        <path fill="url(#notoTeacherLightSkinToneh)"
                                        ...
                                        <radialGradient id="notoTeacherLightSkinTonei" cx="43.529" cy="115.276"
                                            r="8.575" gradientTransform="matrix(1 0 0 -1.2233 0 153.742)"
                                            gradientUnits="userSpaceOnUse">
                                            <stop offset=".702" stop-color="#454140" stop-opacity="0" />
                                            <stop offset="1" stop-color="#454140" />
                                        </radialGradient>
                                        <path fill="url(#notoTeacherLightSkinTonei)"
                                            d="M39.84 4.68c-.01.01-.03.01-.06.03h-.01c-.93.39-8.24 3.78-5.51 12.25l7.78 1.25c-6.89-6.98-2.17-13.55-2.17-13.55s-.02.01-.03.02" />
                                        <radialGradient id="notoTeacherLightSkinTonej" cx="42.349" cy="100.139"
                                            r="16.083"
                                        ...
                                        <path fill="url(#notoTeacherLightSkinTonej)"
                                        ...
                                        <radialGradient id="notoTeacherLightSkinTonek" cx="38.533" cy="84.609"
                                            r="16.886"
                                        ...
                                        <path fill="url(#notoTeacherLightSkinTonek)"
            ...
            <div class="d-flex justify-content-between align-items-center w-100 mb-2">
                <h3 class="">Danh sách tất cả người dùng</h3>
                <div class="gap-2">
                    <a href="{{ route('admin.account-add') }}" class="btn  btn-primary">
                        <i class="fas fa-plus me-2"></i> Thêm người dùng
                    </a>
                    <a href="{{ route('admin.account.trash') }}" class="btn btn-secondary">
                            ...
                            <form id="filterAccountForm" method="GET" action="{{ route('admin.account.search') }}"
                                ...
                                <div class="col-md-2">
                                    <select name="filter" class="form-select">
                                        ...
                                        @if (auth()->user()->isAdmin())
                                            ...
                                            <option value="train" {{ request('filter') == 'train' ? 'selected' : '' }}>
                                                Đào tạo
                                            </option>
                                            <option value="accountant"
                                                {{ request('filter') == 'accountant' ? 'selected' : '' }}>
                                                Kế toán
                                            </option>
                                            <option value="student"
                                                {{ request('filter') == 'student' ? 'selected' : '' }}>Học
                                                sinh
                                            </option>
                                            <option value="teacher"
                                                {{ request('filter') == 'teacher' ? 'selected' : '' }}>
                                                Giáo
                                                viên
                                            </option>
                                ...
                                <div class="col-md-3">
                                    <div class="position-relative">
                                        <input type="search" name="queryAccount" class="form-control"
                                            placeholder="Tìm người dùng..." autocomplete="off"
                                            value="{{ request()->query('queryAccount') ?? '' }}">
                                ...
                                <div class="col-md-2 flex-fill">
                                    ...
                                    <button id="clearFilterAccountBtn" type="button" class="btn btn-danger">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    {{-- <a href="{{ route('admin.account.detail', ['role' => $data->role, 'id' => $data->id]) }}"
                                                        class="btn btn-soft-primary btn-sm">
                                                        <iconify-icon icon="solar:eye-broken"
                                                            class="align-middle fs-18"></iconify-icon>
                                                    </a> --}}

                                                    <a href="{{ route('admin.account.edit', ['role' => $data->role, 'id' => $data->id]) }}"
                                                    ...
                                                    @if (auth()->user()->isAdmin())
                                                        <a href="#" class="btn btn-soft-danger btn-sm"
                                                            onclick="showDeleteConfirm({{ $data->id }}, '{{ $data->name }}', '{{ $data->role }}')">
