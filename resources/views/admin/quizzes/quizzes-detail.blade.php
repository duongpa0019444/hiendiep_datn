                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 d-flex justify-content-between">
                            ...
                            @if ($quiz->course)
                                <p><strong>Khóa học:</strong> {{ $quiz->course->name }}</p>
                            @endif
                                    ...
                                    <div class="card-header d-flex justify-content-between align-items-start flex-wrap">
                                        <div>
                                            <div class="d-flex flex-wrap align-items-center">
                                                ...
                                                <p class="card-text mb-0 "><strong></strong> {{ $question->content }}</p>
                                            </div>
                                    ...
                                    <div class="card-header d-flex justify-content-between align-items-start flex-wrap">
                                        <div>
                                            <div class="d-flex flex-wrap align-items-center">
                                                ...
                                                <p class="card-text mb-0 "><strong></strong> {{ $question->prompt }}</p>
                                            </div>
                                            <p class="card-text mt-2 mb-0 fs-6"><strong>Loại:</strong>
                                                {{ $question->type == 'fill' ? 'Điền từ' : 'Sắp xếp câu' }}</p>
                                        </div>
                                        <div class="mt-2 mt-md-0">
                                            <a href="{{ route('admin.questions.sentence.edit', ['id' => $question->id]) }}"
                                                class="btn btn-soft-primary btn-sm me-1 btn-edit-question" title="Sửa"
                                                data-questiontype="{{ $question->type }}">
                                                <iconify-icon icon="solar:pen-2-broken" class="fs-18"></iconify-icon>
                                            </a>
                                            <form
                                                action="{{ route('admin.questions.sentence.delete', ['id' => $question->id]) }}"
                                                method="POST" class="d-inline-block delete-question-form">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button"
            ...
            <div class="modal fade custom-modal" id="modal-add-question" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        ...
                        <form id="question-form" action="{{ route('admin.questions.store', ['id' => $quiz->id]) }}"
                            method="POST">
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        ...
                        <form id="fill-question-form"
                            action="{{ route('admin.questions.sentence.store', ['id' => $quiz->id]) }}" method="POST">
                            <input type="hidden" name="_method" value="POST">
                            <input type="hidden" name="quiz_id" value="{{ $quiz->id }}">
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#question-form').attr('action',
                                `/admin/questions/${response.question.id}/update`);
                ...
                <div class="col-12 question-item"  id="question-${ question.id }">
                    <div class="card border-purple shadow-sm">
                        <div class="card-header d-flex justify-content-between align-items-start flex-wrap">
                            ...
                            <div class="mt-2 mt-md-0">
                                <a href="/admin/questions/${question.id}/edit" class="btn btn-soft-primary btn-sm me-1 btn-edit-question" title="Sửa"
                                    data-questiontype = "multiple_choice">
                                    <iconify-icon icon="solar:pen-2-broken" class="fs-18"></iconify-icon>
                                </a>
                                <form action="/admin/questions/${question.id}/delete" method="POST" class="d-inline-block delete-question-form">
                ...
                <div class="col-12 question-item" id="question-${question.id}">
                    <div class="card border-purple shadow-sm">
                        <div class="card-header d-flex justify-content-between align-items-start flex-wrap">
                            ...
                            <div class="mt-2 mt-md-0">
                                <a href="/admin/questions-sentence/${question.id}/edit"
                                class="btn btn-soft-primary btn-sm me-1 btn-edit-question"
                                title="Sửa"
                                data-questiontype="${question.type}">
                                    <iconify-icon icon="solar:pen-2-broken" class="fs-18"></iconify-icon>
                                </a>
                                <form action="/admin/questions-sentence/${question.id}/delete" method="POST" class="d-inline-block delete-question-form">
                                    <input type="hidden" name="_method" value="DELETE">
                                    <input type="hidden" name="_token" value="${document.querySelector('meta[name=csrf-token]').getAttribute('content')}">
                                    <button type="submit" class="btn btn-soft-danger btn-sm delete-question-btn" title="Xóa">
                                        <iconify-icon icon="solar:trash-bin-minimalistic-2-broken" class="fs-18"></iconify-icon>
